...
def genData():
    data=pd.read_csv(r'tags.txt',low_memory=False)
    ...
    data.columns = ['user', 'item', 'tag','data']
    # data["tag"] = data["tag"].map({"funny": 0, "Highly quotable": 1, "will ferrell": 2,"Boxing story":3})
...
if __name__=='__main__':
    ...
    recall, precision, coverage, popularity=evaluate(train,test,G,alpha,max_depth,N,user_items,item_tags)
